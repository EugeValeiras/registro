...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "registro@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "registro API";

        private String description = "registro API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "registro";
