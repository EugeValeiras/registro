...
gulp.task('copy', function () {
    return es.merge( 
        ...
        gulp.src(config.bower + 'bootstrap/dist/css/*.css')
        .pipe(plumber({errorHandler: handleErrors}))
        .pipe(changed(config.dist + 'bower_components/bootstrap/dist/css/'))
        .pipe(rev())
        .pipe(gulp.dest(config.dist + 'bower_components/bootstrap/dist/css/'))
